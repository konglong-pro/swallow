...
def default_worker_settings() -> dict[str, WorkerSettings]:
    return {
        ...
        for name, settings in {
            ...
            "chatgpt_share": {"enabled": True, "timeout_seconds": 120, "headless": True},
            "gemini_share": {"enabled": True, "timeout_seconds": 120, "headless": True},
            "claude_share": {"enabled": True, "timeout_seconds": 120, "headless": True},
            "deepseek_share": {"enabled": True, "timeout_seconds": 120, "headless": True},
            "wechat_article": {"enabled": True, "timeout_seconds": 120, "headless": True},
            "youtube_transcript": {"enabled": True, "timeout_seconds": 120},
            "youtube_asr": {
                "enabled": False,
                "timeout_seconds": 1800,
...
WORKER_NAME_TO_CONFIG_KEY = {
    ...
    "chatgpt_share_worker": "chatgpt_share",
    "gemini_share_worker": "gemini_share",
    "claude_share_worker": "claude_share",
    "deepseek_share_worker": "deepseek_share",
    "wechat_article_worker": "wechat_article",
    "youtube_transcript_worker": "youtube_transcript",
    "youtube_asr_worker": "youtube_asr",
